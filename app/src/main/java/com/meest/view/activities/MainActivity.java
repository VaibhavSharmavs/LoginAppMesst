...
import com.meest.R;
import com.meest.databinding.ActivityMainBinding;
import com.meest.model.login.Login;
import com.meest.model.login.components.RoundedView;
...
import com.meest.viewmodel.login.LoginViewModel;
import com.meest.viewmodel.login.LoginViewModelFactory;
...
//                    Toast.makeText(LoginSignUpActivity.this, "Your Username length is less than 4", Toast.LENGTH_SHORT).show();
    ...
    public void onClick(View v) {
        ...
        if(v.getId()==R.id.tv_login){
            ...
            signUp_submit.setVisibility(View.GONE);
