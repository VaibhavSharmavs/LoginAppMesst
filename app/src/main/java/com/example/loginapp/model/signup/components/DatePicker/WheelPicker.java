package com.example.loginapp.model.signup.components.DatePicker;
...
import com.example.loginapp.model.signup.components.DatePicker.util.LinearGradient;
...
public class WheelPicker<T> extends View {
	...
	private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mCurtainColor = a.getColor(R
						.styleable.WheelPicker_wheelCurtainColor,
